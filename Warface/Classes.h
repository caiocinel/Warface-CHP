...
#include <map>
#pragma region sheh
#define IGameFramework_Address 0x1B2C0AC //Pesquisar por "Failed to create the GameFramework Interface!", abra o Xrefs vá até o local e procure por algo que comece of off_ um pouco acima
#define SsystemGlobalEnvironmentAdressRU 0x18F62B0 //ai_CompatibilityMode
